...
echo $status;
            ...
            <form method="post" class="profile-info-form" name="changepassword" onsubmit="return checkpass();">
                                         <div class="col-md-12 col-sm-12 col-lg-12">
                                                               ...
                                                               <input class="brd-rd3" type="password" name="currentpassword" id="currentpassword"required="true" style="border:solid 1px #000">
                                                            </div>

   <div class="col-md-12 col-sm-12 col-lg-12">
                                                               <label>New Password<sup>*</sup></label>
                                                               <input class="brd-rd3" type="password" id="newpassword" value="" name="newpassword" required="true" style="border:solid 1px #000">
                                                            </div>

   <div class="col-md-12 col-sm-12 col-lg-12">
                                                               <label>Confirm Password<sup>*</sup></label>
                                                               <input class="brd-rd3" type="password" id="confirmpassword" value="" name="confirmpassword" required="true" style="border:solid 1px #000">
                                                            </div>
                                                      ...
                                                      <form class="profile-info-form">
                                                         <div class="row mrg20">
                                                            <div class="col-md-12 col-sm-12 col-lg-12">
                                                               ...
                                                               <input class="brd-rd3" type="text" value="<?php  echo $row['FirstName'];?>" id="firstname" name="firstname" required="true" style="border:solid 1px #000">
                                                            </div>
                                                            <div class="col-md-12 col-sm-12 col-lg-12">
                                                               <label>Lasr Name <sup>*</sup></label>
                                                               <input class="brd-rd3" type="text" value="<?php  echo $row['LastName'];?>" id="lastname" name="lastname" required="true" style="border:solid 1px #000">
                                                            </div>
                                                            <div class="col-md-12 col-sm-12 col-lg-12">
                                                               <label>Email address <sup>*</sup></label>
                                                               <input class="brd-rd3" type="text" name="email" value="<?php  echo $row['Email'];?>" readonly="true" style="border:solid 1px #000">
                                                            </div>
                                                      
                                                            <div class="col-md-6 col-sm-6 col-lg-6">
                                                               <label>Mobile Number <sup>*</sup></label>
                                                               <input class="brd-rd3" type="text" id="mobilenumber" name="mobilenumber" value="<?php  echo $row['MobileNumber'];?>" readonly="true" style="border:solid 1px #000">
                                                            </div>
                                                       
                                                            <div class="col-md-6 col-sm-6 col-lg-6">
                                                               <label>Registraton Date </label>
                                                               <input class="brd-rd3" type="text" name="regdate" value="<?php  echo $row['RegDate'];?>" readonly="true" style="border:solid 1px #000">
                                                            </div>
